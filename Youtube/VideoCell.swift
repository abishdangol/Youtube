...
class VideoCell: BaseCell {
    ...
    let thumbnailImageView: CustomImageView = {
        ...
        imageView.image = UIImage(named: "Harvard")
    ...
    let userProfileImageView: CustomImageView = {
        let imageView = CustomImageView()
        imageView.image = UIImage(named: "HarvardIcon")
    ...
    let titleLabel: UILabel = {
        ...
        label.text = "Harvard University - Video ©"
    ...
    let subtitleTextView: UITextView = {
        ...
        textView.text = "Harvard University is one of the best Universities in the world."
